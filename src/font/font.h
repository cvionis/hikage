...
static F_FontCache *f_parse_and_cache_font_ttf(Arena *arena, String8 path, F32 *sizes_pt, U32 sizes_count);
static V2S32 f_text_string_dim_px(String8 text, F_FontCache *font, F32 size_pt);
